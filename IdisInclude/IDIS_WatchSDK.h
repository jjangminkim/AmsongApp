...
#endif
{
    ...
    CHAR    _szCameraDescription[MAX_SYS_CAMERA32][MAX_LEN_CAMERA_TITLE + 1];	// each camera name
    CHAR    _cameraStatus[MAX_SYS_CAMERA32];			// not activated, activated, no video..
    CHAR    _ptzStatus[MAX_SYS_CAMERA32];
    CHAR    _cameraCovertLevel[MAX_SYS_CAMERA32];
    CHAR    _audioInStatus[MAX_SYS_CAMERA32];
    CHAR    _audioOutStatus[MAX_SYS_CAMERA32];
    CHAR    _alarmInDescription[MAX_SYS_CAMERA32][MAX_LEN_DESCRIPTION + 1];
    CHAR    _alarmInStatus[MAX_SYS_CAMERA32];
    CHAR    _alarmOutDescription[MAX_SYS_CAMERA32][MAX_LEN_DESCRIPTION + 1];
    CHAR    _alarmOutStatus[MAX_SYS_CAMERA32];
    CHAR    _recordingStatus[MAX_SYS_CAMERA32];
    UINT32  _multiStreamStatus[MAX_SYS_CAMERA32];
    CHAR    _remoteAudioInStatus[MAX_SYS_CAMERA32];
